...
class JAX
{
	...
	function getScript(){
		...
		$siteType	= (cmsVersion() == _CMS_JOOMLA15) ? '1.5' : '1.0';
...
// 								$key = $d[0];
// 								
// 								// if key is still an array do a for loop.
...
// 								else
// 								{
// 									$val = $this->br2nl(rawurldecode($d[1]));
// 									
...
// 							} else {
// 								if($d != '_d_' ){
// 									$decoded = $this->br2nl(rawurldecode($d));
// 								}
// 							}
// 						}
						}
